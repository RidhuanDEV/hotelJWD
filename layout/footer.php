    ...
    <footer class="bg-dark text-center text-white mt-5">
        ...
        <div class="container text-center text-md-start">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                <!-- Content -->
                <h6 class="text-uppercase fw-bold">Hotel Ridhuan Rangga Kusuma</h6>
                <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #7c4dff; height: 2px;" />
                <p>
                Hotel Ridhuan Rangga Kusuma adalah website tempat memesan hotel yang ada di Tangerang Selatan.
                </p>
            </div>
            <!-- Grid column -->
            <!-- Grid column -->
            ...
            <!-- copyright -->
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                <p class="mb-0">&copy; 2024 Hotel Ridhuan Rangga Kusuma. All Rights Reserved.</p>
            </div>
            <!-- Grid column -->
            </div>
            <!-- Grid row -->
